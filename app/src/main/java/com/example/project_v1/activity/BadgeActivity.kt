...
class BadgeActivity : AppCompatActivity(){
    ...
    fun setBadge(badgeInnerBox: BadgeInnerBox){
        findViewById<ImageView>(R.id.badgeInnerImageView).setImageResource(badgeInnerBox.badgeDrawableID)
        findViewById<TextView>(R.id.badgeInnerTextView).setText(badgeInnerBox.badgeTitle)
        MainActivity().findViewById<TextView>(R.id.userTitleTextView).text = badgeInnerBox.badgeTitle
        MainActivity().findViewById<TextView>(R.id.userTitleText).text = badgeInnerBox.badgeName
        MainActivity().findViewById<ImageView>(R.id.userBadgeImageView).setImageResource(badgeInnerBox.badgeDrawableID)
    }
